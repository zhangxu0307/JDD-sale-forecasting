...
def buildTrainModel(modelIndex):
    ...
    rf2 = RandomForestRegressor(n_estimators=100, max_depth=10, max_features=None)

    rf3 = XGBRegressor(objective="reg:linear", n_estimators=200, learning_rate=0.1,
                       max_depth=15, min_child_weight=6, subsample=0.9,
                       colsample_bytree=0.8, silent=False, reg_lambda=0.0, seed=0)
